                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtDateCash" TextMode="Date" class="form-control form-control-sm" runat="server"></asp:TextBox>
                                    <div class="custom-control mt-2  custom-checkbox ">
                                        <input type="checkbox" class="custom-control-input" id="CashDueDate" checked="true" runat="server" clientidmode="Static" />
                                        <label class="custom-control-label mt-1 small text-gray-900 " for="CashDueDate">Don't Update the due date</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 col-sm-4">
                                ...
                                <div class="custom-control mt-2  custom-checkbox ">
                                    <input type="checkbox" class="custom-control-input" id="BankDueDate" checked="true" runat="server" clientidmode="Static" />
                                    <label class="custom-control-label mt-1 small text-gray-900 " for="BankDueDate">Don't Update the due date</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtDateBank" TextMode="Date" class="form-control form-control-sm" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th class="text-center border-right border-left">
                                                            <asp:CheckBox ID="chkHeader3" runat="server" /></th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <th class="text-center  border-right border-left">
                                                <asp:CheckBox ID="chkRow3" runat="server" /></th>
