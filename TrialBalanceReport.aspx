<%@ Page Title="" Language="C#" MasterPageFile="~/Finance/Accounta/AccountMasterPage.master" AutoEventWireup="true" CodeBehind="TrialBalanceReport.aspx.cs" Inherits="advtech.Finance.Accounta.TrialBalanceReport" %>
                ...
                <div id="con" runat="server">
                    ...
                    <div class="card-header text-black bg-white font-weight-bold">
                        <center>
                            ...
                            <h4 class="mb-1 font-weight-bold text-gray-900 ">Trial Balance</h4>
                        ...
                        <div class="col-8">
                                ...
                                <HeaderTemplate>
                                    ...
                                    <table class="table align-items-center table-sm">
                                        <thead>
                                            ...
                                            <tr>
                                                <td class="text-xs text-gray-900 font-weight-bold">Debit(Dr.)</td>
                                    ...
                                    <tr>
                                        <td class="text-primary font-weight-normal">
                                            <a title="Show the details" href="LedgerDetail.aspx?led=<%# Eval("Account")%>">
                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("Account")%>'></asp:Label></a>
                                        </td>
                                        <td class="text-right text-gray-900">
                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("Balance", "{0:N2}")%>'></asp:Label>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                            ...
                            <table class="table align-items-center table-sm">
                                <thead>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold  text-gray-900 text-uppercase">Total Debit</td>
                                        <td></td>

                                        <td>
                                            <h6 id="H1" class=" text-gray-900 text-lg-right font-weight-bold" runat="server" text="0.00"></h6>
                                        </td>
                                    </tr>
                            ...
                            <asp:Repeater ID="Repeater2" runat="server">
                                ...
                                <HeaderTemplate>
                                    ...
                                    <table class="table align-items-center table-sm">
                                        <thead>
                                            ...
                                            <tr>
                                                <td class="text-xs text-gray-900 font-weight-bold">Credit(Cr.)</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-primary font-weight-normal">
                                            <a title="Show the details" href="LedgerDetail.aspx?led=<%# Eval("Account")%>">
                                                <asp:Label ID="Label4" runat="server" Text='<%#Eval("Account")%>'></asp:Label></a>
                                        </td>
                                        <td class="text-right  text-gray-900">
                            ...
                            <table class="table align-items-center table-sm">
                                <thead>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold text-gray-900  text-uppercase">Total Credit</td>
                                        <td></td>

                                        <td>
                                            <h6 id="Label2" class=" text-gray-900 text-lg-right font-weight-bold" runat="server" text="0.00"></h6>
                                        </td>
                                    </tr>
