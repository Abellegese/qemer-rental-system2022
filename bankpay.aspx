<%@ Page Title="" Language="C#" MasterPageFile="~/Finance/Accounta/AccountMasterPage.Master" AutoEventWireup="true" CodeBehind="bankpay.aspx.cs" Inherits="advtech.Finance.Accounta.bankpay" %>
...
<div class="card border-left-primary " >
                <div class="card-body" id="hidediv" runat="server">
                           <div class="row">
            ...
            <div class="input-group input-group-alternative">
             <asp:Button ID="Button3" runat="server" class="btn mt-2 btn-secondary" Text="Save" OnClick="Button3_Click"/>
                               ...
                               <div class="col-md-3 col-sm-4">
                                  ...
                                  <asp:TextBox ID="txtDuedate" required="true" class="form-control" TextMode="Date" runat="server"></asp:TextBox>
                                   </div>
                               </div>
        </div>                         
                </div>
