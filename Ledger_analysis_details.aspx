        ...
        <div class="col">
            ...
            <div class="col-lg-4 border-right">
                ...
                <div class="card-body">
                  ...
                  <hr />	<div style="overflow-y:scroll; height:450px" class="mb-3 border-bottom">
        	...
        	<asp:Label ID="Label2" runat="server" Visible="false" Text=<%#Eval("Account")%>></asp:Label>
              ...
              <ul class="timeline">
				...
				<li>
					...
					<p >
                        <asp:Label ID="Label5" class="small text-gray-900 font-weight-bold" runat="server"></asp:Label> by <span class="text-success small"><%#Eval("Date","{0: MMMM dd, yyyy}")%></span></p>
            ...
            <div class="col-xl-4 col-md-12 mb-1 border-right">
                ...
                <div class="card-body">
                  <div class="row ">
                      ...
                      <div class="h5 mb-0 font-weight-light  text-gray-800"><span id=TotDebitor runat=server></span>
                    ...
                    <div class="dropdown-menu  dropdown-menu-left shadow animated--fade-in text-center" data-backdrop="static" style="width:600px" aria-labelledby="dropdownMenuLink2">
                      <div class="dropdown-header  font-weight-bolder text-success">Monthly Account Increase Trends</div><span id="Dec" runat="server" class="mx-bar2 small text-gray-bg-gray-600"></span>
            ...
            <div class="col-xl-4 col-md-6 mb-1 border-right">
                ...
                <div class="card-body">
                  <div class="row ">
                      ...
                      <div class="h5 mb-0 font-weight-light  text-gray-800"><span id="TotalCreditor"  runat=server></span>
                    ...
                    <div class="dropdown-menu  dropdown-menu-right shadow animated--fade-in text-center" style="width:600px" aria-labelledby="dropdownMenuLink2">
                      <div class="dropdown-header  font-weight-bolder text-danger">Monthly Account Decrease Trends</div><span id="InTrendDate"  runat="server" class="mx-bar2 small text-gray-bg-gray-600"></span>
                        <div class="dropdown-divider"></div>
                        <div class="row">
                            <div class="col-12">
...
<table class="table align-items-center table-sm  table-hover" id="dataTable" width="100%" cellspacing="8">
                <thead class="">
                  <tr>
                    ...
                    <th scope="col"  class="text-gray-900 text-right">
                         Date</th>
