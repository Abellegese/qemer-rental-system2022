<%@ Page Title="" Language="C#" MasterPageFile="~/Finance/Accounta/AccountMasterPage.Master" AutoEventWireup="true" CodeBehind="creditnoteopeningpayment.aspx.cs" Inherits="advtech.Finance.Accounta.creditnoteopeningpayment" %>
      ...
      <div class="row">
        ...
        <div id="div_print"> 
              ...
              <div class="card mb-4">
                ...
                <span id="item" runat="server" class="h6 text-center m-0 font-weight-bold text-primary">Pay via Cash</span>
...
<label class="input-group-text">ETB</label>
          ...
          <div class="form-group mb-0">
            ...
            <div class="input-group input-group-alternative">
           <asp:TextBox ID="txtReference" class="form-control" runat="server" required="true"></asp:TextBox>
