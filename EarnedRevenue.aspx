                ...
                <thead >
                  <tr>
                    ...
                    <th scope="col">
                      ...
                      <th>REFERENCE</th>
                    <th scope="col" class="text-right"><asp:LinkButton ID="LinkButton2" class="text-gray-900" runat="server" CommandName="Date">DATE</asp:LinkButton></th>
                     <th scope="col" class="text-right" ><asp:LinkButton ID="LinkButton3" class="text-danger" runat="server" CommandName="Payment">AMOUNT</asp:LinkButton></th>
